...
namespace dbApp {
    ...
    public partial class EmployeeDBDataSet : global::System.Data.DataSet {
        ...
        public partial class AssetsDataTable : global::System.Data.TypedTableBase<AssetsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AssetsRow AddAssetsRow(EmployeesRow parentEmployeesRowByEmployeesAssets, string Description, int AssetID) {
...
namespace dbApp.EmployeeDBDataSetTableAdapters {
    ...
    public partial class AssetsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Assets` (`EmployeeID`, `Description`, `AssetID`) VALUES (?, ?, ?)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dbApp.Properties.Settings.Default.EmployeeDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Description, AssetID FROM Assets";
        ...
        public virtual int Insert(global::System.Nullable<int> EmployeeID, string Description, global::System.Nullable<int> AssetID) {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Employees` WHERE ((`Employee ID` = ?) AND ((? = 1 AND `firstName` IS" +
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`Employee ID`, `firstName`, `lastName`) VALUES (?, ?, ?)" +
                "";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Employees` SET `Employee ID` = ?, `firstName` = ?, `lastName` = ? WHERE (" +
                "(`Employee ID` = ?) AND ((? = 1 AND `firstName` IS NULL) OR (`firstName` = ?)) A" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT [Employee ID], firstName, lastName FROM Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
